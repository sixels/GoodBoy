...
lazy_static::lazy_static! {
    ...
    static ref OPCODE_VEC: Vec<Opcode<'static>> = vec![
        ...
        Opcode::new(0x34, 1, 4, Instruction::INC8(Operand::HL), "INC (HL)"),
        ...
        Opcode::new(0x35, 1, 4, Instruction::DEC8(Operand::HL), "DEC (HL)"),
        ...
        Opcode::new(0x36, 2, 8, Instruction::LDIM8(Operand::HL), "LD (HL),u8"),
        ...
        Opcode::new(0xC5, 1, 12, Instruction::PUSH(Operand::BC), "PUSH BC"),
        Opcode::new(0xD5, 1, 12, Instruction::PUSH(Operand::DE), "PUSH DE"),
        Opcode::new(0xE5, 1, 12, Instruction::PUSH(Operand::HL), "PUSH HL"),
        Opcode::new(0xF5, 1, 12, Instruction::PUSH(Operand::AF), "PUSH AF"),
        ...
        Opcode::cb(0x46, 1, 16, Instruction::BIT(0, Operand::HL), "BIT 0,(HL)"),
        ...
        Opcode::cb(0x4E, 1, 16, Instruction::BIT(1, Operand::HL), "BIT 1,(HL)"),
        ...
        Opcode::cb(0x56, 1, 16, Instruction::BIT(2, Operand::HL), "BIT 2,(HL)"),
        ...
        Opcode::cb(0x5E, 1, 16, Instruction::BIT(3, Operand::HL), "BIT 3,(HL)"),
        ...
        Opcode::cb(0x66, 1, 16, Instruction::BIT(4, Operand::HL), "BIT 4,(HL)"),
        ...
        Opcode::cb(0x6E, 1, 16, Instruction::BIT(5, Operand::HL), "BIT 5,(HL)"),
        ...
        Opcode::cb(0x76, 1, 16, Instruction::BIT(6, Operand::HL), "BIT 6,(HL)"),
        ...
        Opcode::cb(0x7E, 1, 16, Instruction::BIT(7, Operand::HL), "BIT 7,(HL)"),
